...
/**
 * Created by Tony on 12-Mar-15.
 */
import android.graphics.Bitmap;
import android.graphics.drawable.Drawable;

public interface MyResourceProxy {

    public static enum string {

        // tile sources
        mapnik, cyclemap, public_transport, cloudmade_small, cloudmade_standard, mapquest_osm, mapquest_aerial, bing, mapbox, camino,
